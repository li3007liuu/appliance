...
public class ColorTemplate {
    ...
    public static final int[] DLXB_COLORS = {
            rgb("#2ecc71"),  rgb("#3498db")
    };
    public static final int[] DYXB_COLORS = {
            rgb("#f1c40f"),  rgb("#e74c3c")
    };

    public static final int[] INDIGO_COLORS = {
            rgb("#e8eaf6"),rgb("#c5cae9"),rgb("#9fa8da"),
            rgb("#7986cb"),rgb("#5c6bc0"),rgb("#3f51bf"),
            rgb("#3949ab"),rgb("#303f9f"),rgb("#283593"),
            rgb("#1a237e")
    };
    public static final int[] BLUE_COLORS = {
            rgb("#e7e9fd"),rgb("#d0d9ff"),rgb("#afbfff"),
            rgb("#91a7ff"),rgb("#738ffe"),rgb("#5677fc"),
            rgb("#4e6cef"),rgb("#455ede"),rgb("#3b50ce"),
            rgb("#2a36b1")
    };
